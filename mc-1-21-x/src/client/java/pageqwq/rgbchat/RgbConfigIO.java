...
public final class RgbConfigIO {
    ...
    private static Path file() {
        return FabricLoader.getInstance().getConfigDir().resolve("rgbchat.json");
    }
    ...
    public static void load() {
        ...
        if (Files.exists(file)) {
            try (Reader reader = Files.newBufferedReader(file)) {
                ...
                RgbChatClient.LOGGER.warn("Failed to read {}, using defaults", file, e);
    ...
    public static void save() {
        ...
        try {
            ...
            RgbChatClient.LOGGER.warn("Failed to write {}", file, e);
        }
    }
}
